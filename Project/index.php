            ...
            <form method ="POST" action= "reg_control.php">
              ...
              <div class="row">
               ...
               <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline"> 
                  	<label class="form-label" for="publisname">Publisher Name</label>
                    <input type="text" id="publisname" name="publisname" class="form-control form-control-lg" />
              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline"> 
                    ...
                    <input type="number" id="pageno" name="pageno"  class="form-control form-control-lg" />
              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline"> 
                  	<label class="form-label" for="publisdate">publis date</label>
                    <input type="date" id="publisdate" name="publisdate" class="form-control form-control-lg" />
              ...
              <div class="col-md-6 mb-4">
                  ...
                  <h6 class="mb-2 pb-1">Book Type: </h6>
                    ...
                    <input type="radio" name="booktype" value="Science" checked > <b  >Science </b>
